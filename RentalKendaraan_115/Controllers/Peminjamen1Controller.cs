...
{
    public class Peminjamen1Controller : Controller
    {
        private readonly Rent_KendaraanContext _context;

        public Peminjamen1Controller(Rent_KendaraanContext context)
        {
            _context = context;
        }
